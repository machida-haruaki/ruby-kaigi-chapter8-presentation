...
> **注意：バージョンについて**
> 本資料の原典「Rubyのしくみ」（Ruby Under a Microscope）はRuby 2.0をベースにしています。
> 構造体名・フィールド名が現在のRuby 3.4と異なります。
> セクション3.2〜3.5のC構造体・疑似コードは本書の説明を元にした概念的なものです。
> **実際のRuby 3.4の構造体は 3.7補足** で解説します。
